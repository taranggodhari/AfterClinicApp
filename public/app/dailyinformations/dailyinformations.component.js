System.register(['@angular/core', './dailyinformations.service', '../authentication/authentication.service'], function(exports_1, context_1) {
    ...
    var DailyInformationsComponent;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            DailyInformationsComponent = (function () {
                function DailyInformationsComponent(_authenticationService) {
                    this._authenticationService = _authenticationService;
                    this.user = _authenticationService.getLoggedInUser();
                }
                DailyInformationsComponent = __decorate([
                    core_1.Component({
                        selector: "dailyinformations",
                        templateUrl: "app/dailyinformations/dailyinformations.template.html",
                        providers: [dailyinformations_service_1.DailyInformationsService]
                    }), 
                    __metadata('design:paramtypes', [authentication_service_1.AuthenticationService])
                ], DailyInformationsComponent);
                return DailyInformationsComponent;
            }());
            exports_1("DailyInformationsComponent", DailyInformationsComponent);
        }
    }
});
//# sourceMappingURL=dailyinformations.component.js.map